...
This data was scraped from the Wot-News website. This website pulls data from Wargamings servers in order to provide data on server activity and tanks statistics. This is updated daily and this project will take data from the last 60 days from the current day. This data can all be viewed on the Wot News website at: https://wot-news.com/.
